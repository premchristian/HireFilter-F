...
export default function SmokeCanvas() {
    ...
    useEffect(() => {
        ...
        const support_linear_float = glContext.support_linear_float
        ...
        const advectionProgram = new GLProgram(baseVertexShader, support_linear_float ? advectionShader : advectionShader)
